...
execute store result score $$ txcw run data get storage txcw:core record.knots[-2].pos.p[0]
scoreboard players operation $ txcw -= $$ txcw
execute store result storage txcw:core record.knots[-2].pos.m[0] int 1 run scoreboard players operation $ txcw /= $3 txcw

execute store result score $ txcw run data get storage txcw:core record.knots[-1].pos.p[1]
execute store result score $$ txcw run data get storage txcw:core record.knots[-2].pos.p[1]
scoreboard players operation $ txcw -= $$ txcw
execute store result storage txcw:core record.knots[-2].pos.m[1] int 1 run scoreboard players operation $ txcw /= $3 txcw

execute store result score $ txcw run data get storage txcw:core record.knots[-1].pos.p[2]
execute store result score $$ txcw run data get storage txcw:core record.knots[-2].pos.p[2]
scoreboard players operation $ txcw -= $$ txcw
execute store result storage txcw:core record.knots[-2].pos.m[2] int 1 run scoreboard players operation $ txcw /= $3 txcw
...
scoreboard players operation $ txcw -= $$ txcw
execute store result storage txcw:core record.knots[-2].rot.m[0] int 1 run scoreboard players operation $ txcw /= $3 txcw
...
execute store result score $$ txcw run data get storage txcw:core record.knots[-2].vel.p
scoreboard players operation $ txcw -= $$ txcw
execute store result storage txcw:core record.knots[-2].vel.m int 1 run scoreboard players operation $ txcw /= $3 txcw

# 先頭の制御ベクトルひとつ前のものと同じ
data modify storage txcw:core record.knots[-1].vel.m set from storage txcw:core record.knots[-2].vel.m
