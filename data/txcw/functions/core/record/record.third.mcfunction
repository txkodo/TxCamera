...
execute store result score $$ txcw run data get storage txcw:core record.knots[-3].rot.p[2]
scoreboard players operation $ txcw -= $$ txcw
execute store result storage txcw:core record.knots[-2].rot.m[2] int 1 run scoreboard players operation $ txcw /= $4 txcw

execute store result score #1 txcw run data get storage txcw:core record.knots[-1].rot.p[2]
execute store result score #2 txcw run data get storage txcw:core record.knots[-2].rot.p[2]
scoreboard players operation #1 txcw -= #2 txcw
execute store result storage txcw:core record.knots[-1].rot.m[2] int 1 run scoreboard players operation #1 txcw -= $ txcw

execute store result score #1 txcw run data get storage txcw:core record.knots[-2].rot.p[2]
execute store result score #2 txcw run data get storage txcw:core record.knots[-3].rot.p[2]
scoreboard players operation #1 txcw -= #2 txcw
execute store result storage txcw:core record.knots[-3].rot.m[2] int 1 run scoreboard players operation #1 txcw -= $ txcw
